...
onMounted(async () => {
  try {
    ...
    tinNhanBackend.value = "Kết nối thất bại! Hãy chắc chắn bạn đã RUN dự án Spring Boot ở cổng 8080.";
...
<template>
  ...
  <div style="text-align: center; margin-top: 100px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    <h1 style="color: #42b883; font-size: 2.5rem; margin-bottom: 10px;">DỰ ÁN ĐỒ BẾP 🍳</h1>
    <p style="color: #7f8c8d; font-size: 1.1rem;">Kiểm tra đường truyền: Vue 3 (Port 5173) 🤝 Spring Boot (Port 8080)</p>
